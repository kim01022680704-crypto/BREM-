...
create table if not exists public.baemin_delivery_status (
  ...
  bmart_reject integer not null default 0,
  store_reject integer not null default 0,
  total_reject integer not null default 0,
  food_cancel integer not null default 0,
  bmart_cancel integer not null default 0,
  store_cancel integer not null default 0,
  cancel_count integer not null default 0,
  food_rider_fault integer not null default 0,
  bmart_rider_fault integer not null default 0,
  store_rider_fault integer not null default 0,
