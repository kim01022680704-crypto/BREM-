  ...
  function createSupabaseAdapter(client, keys) {
    ...
    function leaseVehicleToRow(item) {
      const raw = {
        ...
        dailyInsuranceCost: Number(item.dailyInsuranceCost || 0)
      };
      return {
        id: item.id,
        ...
        payment_check: item.paymentCheck || '',
        unpaid_collection_method: item.unpaidCollectionMethod || '',
        ...
        acquisition_tax_rate: Number(item.acquisitionTaxRate || 0),
    ...
    function rowToLeaseVehicle(row) {
      ...
      return {
        ...
        dailyInsuranceCost: Number(row.daily_insurance_cost || raw.dailyInsuranceCost || 0),
    ...
    function rowToLeaseContract(row) {
      ...
      return {
        ...
        returnDate: raw.returnDate || row.end_date || '',
